    ...
    public partial class WebEditor : Window
    {
        ...
        public WebEditor()
        {
            ...
            try
            {
                ...
                txtEmasilTo.Text = currentApp.Mtoname;
                txtEmailTo.Text = currentApp.Mtoname;
                txtCC.Text = currentApp.Mcc;
                txtSubject.Text = currentApp.Msubject;
                txtfdSubject.Text = currentApp.Msubject;
                txtdfCC.Text = currentApp.Mcc;
                if (currentApp.htmldata != "") { wbBrowser.Source = new Uri(currentApp.htmldata); }
            } catch { }
           
         
           //webBrowserEditor.newWb(currentApp.htmldata);
        }
